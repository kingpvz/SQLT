...
or just the file name (myworkspace). You can only load .sqlt files.")
                    case "view"|"show"|"print": print("This command prints an array to the screen. Possible aliases: view, show, print.\n\
Syntax: print <array>")
                    case "create": print("This command creates a new array. Syntax: create <array>")
                    case "add": print("This command adds a value to an array.\n\
Syntax: add <value> to <array>")
                    case "del"|"delete": print("This command deletes an array. Possible aliases: del, delete.\n\
Syntax: del <array>")
                    case "len"|"length": print("This command returns the amount of items in an array.\n\
Possible aliases: len, length. Syntax: len <array>")
                    case "remove": print("This command removes a value from array.\n\
Syntax: remove <value> from <array>")
                    case "pop": print("This command removes a value from array.\n\
Syntax: pop <array> <index>")
                    case "ws"|"workspace"|"cw"|"changews"|"changeworkpace": print("This command changes the current/creates a new workspace. The default workspace is root.\n\
Possible aliases: ws, workspace, cw, changews, changeworkspace. Syntax: cw <workspace>")
                    case "info": print("This command shows information about a workspace. If we do not include the workspace name,\n\
...
Output syntax: <workspace> {<array>: <list of values>, <array>: <list of values>, ...}")
                    case "list": print("This command lists all existing workspaces.")
                    case "me": print("Use the 'help <command>' syntax to view help about any command.\n\
If you wish to learn the commands, use 'help tutorial'.")
                    case "tutorial": print("""WELCOME TO SimpleQueryList ARRAY MANAGEMENT LANGUAGE!
